...
/opt/bin/python3 -c 'import sys,ssl,http.server,hashlib,ipaddress,json,secrets,zlib; assert sys.version_info >= (3,10)' || { echo 'ERROR: install python3-light python3-codecs python3-openssl python3-email python3-urllib python3-logging'; exit 1; }
...
for file in server.py index.html app.js style.css; do
